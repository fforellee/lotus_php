...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Nov-2021 às 17:43
...
CREATE TABLE `cliente` (
  ...
  `Cartao_numero` char(16) DEFAULT NULL,
  `Cartao_cod` char(3) DEFAULT NULL,
  `Cartao_vencimento` char(5) DEFAULT NULL,
  `Endereço_Logradouro` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cliente` (`CPF`, `Nome_completo`, `Data_nascimento`, `Sexo`, `Num_tel`, `Email`, `Senha`, `Endereço_CEP`, `Endereço_Num_residencia`, `Endereço_Complemento`, `Cartao_numero`, `Cartao_cod`, `Cartao_vencimento`, `Endereço_Logradouro`) VALUES
('', '', '0000-00-00', '', '', '', '', '', '', '', NULL, NULL, NULL, ''),
('12345678912', 'SonnLasManaaniitasss', '2001-02-04', 'F', '(11) 93379-2882', 'gatinha_@gmail.com', '123', '12345-678', '123', '123', NULL, NULL, NULL, '123');
...
INSERT INTO `compra` (`Data_compra`, `Tipo`, `Cod_barra_Produto`, `CPF_Cliente`, `Cod_cadastro_Funcionario`) VALUES
('2021-11-19', '1', 0, '', NULL);
