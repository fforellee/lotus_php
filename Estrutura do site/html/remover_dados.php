...
<body class="u-body">
  ...
  <h3 class="u-text u-text-default u-text-1">Remover dados da conta</h3>
          ...
          <div class="u-layout-row">
            ...
            <div class="u-container-style u-custom-color-2 u-layout-cell u-size-45 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <h4 class="u-text u-text-default u-text-1"><span class="u-file-icon u-icon u-text-custom-color-4 u-icon-1"><img src="../images/home.png" alt=""></span>
                ...
                <div class="u-form u-form-1">
                  <form action="../php/delete.php" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
                    <div class="u-form-group u-form-group-1">
                      ...
                      <input readonly type="text" value="<?php echo $dados->Endereço_CEP; ?>" id="text-10ca" name="Endereço_CEP" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white" maxlength="9" onkeyup="mascara(this, mcep);">
                    </div>
                    <div class="u-form-group u-form-group-2">
                      <label for="text-c63f" class="u-label u-label-2">Logradouro(s)</label>
                      <input readonly type="text" value="<?php echo $dados->Endereço_Logradouro ?>" id="text-c63f" name="Endereço_Logradouro" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white">
                    </div>
                    <div class="u-form-group u-form-group-4">
                      <label for="text-db53" class="u-label u-label-4">Número da Residência</label>
                      <input readonly type="text" value="<?php echo $dados->Endereço_Num_residencia ?>" id="text-db53" name="Endereço_Num_residencia" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white">
                    </div>
                    <div class="u-form-group u-form-group-5">
                      <label for="text-9ad7" class="u-label u-label-5">Complemento</label>
                      <input readonly type="text" value="<?php echo $dados->Endereço_Complemento ?>" id="text-9ad7" name="Endereço_Complemento" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white">
                    </div>
