            ...
            <div class="u-layout-row">
              <div class="u-container-style u-custom-color-4 u-layout-cell u-size-15 u-layout-cell-1">
                <div class="u-container-layout u-valign-bottom u-container-layout-1">
                  ...
                  <!-- GERAR PDF -->
                  <a href=" ... " data-page-id="857521981" class="u-active-custom-color-6 u-border-3 u-border-hover-white u-border-white u-btn u-button-style u-hover-white u-none u-text-active-white u-text-body-alt-color u-text-hover-custom-color-4 u-btn-3">GERAR PDF</a>
              ...
              <div class="u-container-style u-custom-color-2 u-layout-cell u-size-45 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  ...
                  <p class="u-text u-text-default u-text-20"><?php echo $registro->Cartao_cod; ?></p>
                  <p class="u-text u-text-default u-text-21"><?php echo $registro->Cartao_vencimento; ?> </p>
                  <?php } ?>
                </div>
              </div>
            </div>
